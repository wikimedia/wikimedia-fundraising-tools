...
def banner_results(criteria):
    ...
    results.update({
        'preview': "http://en.wikipedia.org/wiki/Special:Random?banner=" + criteria['banner'],
    ...
    if match:
        results.update({
            ...
            'preview': "http://en.wikipedia.org/wiki/Special:Random?banner=%s&country=%s&uselang=%s" % (criteria['banner'], match.group("country"), match.group("language")),
        })
