...
def test_good_ct_country():
    '''
    Test that we use the contribution_tracking country when no Civi address exists
    '''
...
def test_multiple_ct_country():
    '''
    Test that we use the latest valid contribution_tracking country when no Civi address exists
    '''
